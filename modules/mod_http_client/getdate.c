...
{
       0,   220,   221,   224,   227,   230,   233,   236,   239,   242,
     248,   254,   263,   269,   281,   284,   287,   293,   297,   301,
     307,   311,   329,   335,   341,   345,   350,   354,   361,   369,
     372,   375,   378,   381,   384,   387,   390,   393,   396,   399,
     402,   405,   408,   411,   414,   417,   420,   423,   428,   461,
     465
};
#endif
...
/* The parser invokes alloca or sb_malloc; define the necessary symbols.  */
...
#   endif
#  endif
#  define YYSTACK_ALLOC YYSTD (sb_malloc)
