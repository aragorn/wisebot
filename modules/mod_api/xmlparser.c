...
SB_IMPLEMENT_HOOK_RUN_FIRST(parser_t *,xmlparser_parselen, \
	(const char *charset, const char *xmltext, const int len), \
	(charset,xmltext,len),(parser_t *)1)
SB_IMPLEMENT_HOOK_RUN_FIRST(parser_t *,xmlparser_parser_create, \
	(const char *charset), (charset),(parser_t *)1)
SB_IMPLEMENT_HOOK_RUN_VOID_ALL(xmlparser_free_parser,(parser_t *p),(p))
...
SB_IMPLEMENT_HOOK_RUN_FIRST(int,xmlparser_get_domsize, \
	(parser_t *p), (p),0)
SB_IMPLEMENT_HOOK_RUN_FIRST(field_t *,xmlparser_retrieve_field, \
	(parser_t *p, char *query),(p,query),(field_t *)1)
