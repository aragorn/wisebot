/* $Id$ */
#ifndef _DID_CLIENT_H_
#define _DID_CLIENT_H_ 1
...
SB_DECLARE_HOOK(int,client_get_docid,(char *pKey, DocId *pDocId))
SB_DECLARE_HOOK(int,client_get_new_docid,(char *pKey, DocId *pDocId, DocId *olddid))
SB_DECLARE_HOOK(int,client_get_last_docid,(DocId *pNumDoc))
